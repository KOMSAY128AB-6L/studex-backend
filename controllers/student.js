        ...
        mysql.use('master')
            .query(
                'SELECT CONCAT(CONCAT(teacher.first_name, ", "), teacher.last_name) as "Teacher",\
                    ...
                    teacher.teacher_id = volunteer.teacher_id and student.student_id = volunteer.student_id and class.class_id = volunteer.class_id and\
                    student.student_id= volunteer_student.student_id;',
